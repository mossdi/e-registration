                    ...
                    [
                        ...
                        'buttons' => [
                            'register' => function ($url, $model) {
                                return !$model->participant && (($model->start_time - Yii::$app->setting->get('registerOpen')) <= time()) && (($model->start_time + Yii::$app->setting->get('registerClose')) >= time()) ? Html::a('Участвовать', ['/user/register-participant?user_id=' . Yii::$app->user->id . '&conference_id=' . $model->id . '&method=' . Conference::LEARNING_DISTANCE]) . ' / ' : '';
                            },
